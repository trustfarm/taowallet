    ...
    <article class="col-md-4 col-sm-6">
      ...
      <div ng-show="walletType=='watchonlyaccount'">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" placeholder="0x8df9f63bDdD6918590Fd283969CF9F3BD14b1793" ng-model="addAccount.address" ng-change="watchOnlyChange()" ng-keyup="$event.keyCode == 13 && addWatchOnly()"/>
        </div>
      </div>
