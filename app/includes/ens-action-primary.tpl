  ...
  <article class="row">
    ...
    <section class="col-sm-8">
      ...
      <div class="input-group">
        <input class="form-control" type="text" placeholder="TrustCoinWallet" readonly ng-model="objENS.name"/>
