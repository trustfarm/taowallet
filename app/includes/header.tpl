<!DOCTYPE html>
<html lang="ko" ng-app="mewApp">
<head>
<meta charset="utf-8">
<title>TrustCoinWallet.com for TAO Architecture</title>
<meta name="description" content="TrustCoinWallet.com은 지갑을 생성하고 블록 체인과 쉽고 안전하게 상호 작용할 수있는 무료 오픈 소스 클라이언트 측 인터페이스입니다. 지갑을 잠금 해제하기 전에 URL (.com)을 다시 확인하십시오.">
<link rel="canonical" href="https://trustcoinwallet.com/" />
...
<meta name="apple-mobile-web-app-title" content="TrustCoinWallet &middot; Your Ways to TAO">
<meta name="application-name" content="TrustCoinWallet">
<meta name="msapplication-config" content="images/fav/browserconfig.xml">
<meta name="theme-color" content="#1d6986">
<!-- meta name="google-site-verification" content="IpChQ00NYUQuNs_7Xs6xlnSdzalOlTUYbBsr8f7OpvM" /! -->
<meta property="og:url" content="https://www.trustcoinwallet.com" />
<meta property="og:title" content="TrustCoinWallet.com  &middot; Your Ways to TAO" />
<!-- meta property="og:image" content="/images/myetherwallet-logo-banner.png" / -->
<meta property="og:image" content="/images/trustcoinwallet-logo-banner.svg" />
<meta property="og:image" content="/images/trustcoinwallet-logo-square.svg" />
<meta property="og:image" content="/images/trustcoinwallet-banner-fun.jpg" />
<meta property="og:description" content="TrustCoinWallet.com은 지갑을 생성하고 블록 체인과 쉽고 안전하게 상호 작용할 수있는 무료 오픈 소스 클라이언트 측 인터페이스입니다. 지갑을 잠금 해제하기 전에 URL (.com)을 다시 확인하십시오." />
<script type='application/ld+json'>{"@context":"http://schema.org","@type":"Organization","@id":"#organization","url":"https://www.trustcoinwallet.com/","name":"TrustCoinWallet",
"logo":"trustcoinwalletwallet-logo-banner.png","description": "TrustCoinWallet.com은 지갑을 생성하고 블록 체인과 쉽고 안전하게 상호 작용할 수있는 무료 오픈 소스 클라이언트 측 인터페이스입니다. 지갑을 잠금 해제하기 전에 URL (.com)을 다시 확인하십시오.","sameAs":["https://www.trustcoinwallet.com/",,"https://github.com/trustfarm/taowallet/","https://www.reddit.com/user/trustfarmhub/"]}</script>
</head>
<body>
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header" ng-controller='tabsCtrl' >
  ...
  @@if (site === 'mew' ) {
    <div class="small announcement annoucement-danger">
      <div class="container">Always check the URL and look for TrustCoinWallet.com [KR]. Look for https://trustcoinwallet.com/.<!--  <a href="https://myetherwallet.groovehq.com/knowledge_base/topics/protecting-yourself-and-your-funds" target="_blank" rel="noopener">Be safe &amp; secure</a>. --></div>
    </div>
  }
    ...
    <section class="container">
      @@if (site === 'mew' ) {
        <a class="brand" href="/" aria-label="Go to homepage">
          <img src="images/logo-trustcoinwallet.svg"   height="94px" width="275px" alt="TrustCoinWallet" />
        </a> 
      } <a style="color: #ffffff; padding-top: 9px; padding-left: 9px;"> for TAO &nbsp;</a>
      <a style="color: #156d6a; padding-top: 9px; padding-left: 9px;">[Beta:UnderDevelop]</a>
      @@if (site === 'cx'  ) {
        <a class="brand" href="/cx-wallet.html" aria-label="Go to homepage">
          <img src="images/logo-trustcoinwallet.svg" height="94px" width="275px" alt="TrustCoinWalletCX" />
        </a> for TAO
      }
      <div class="tagline">

        <span style="color: #fff; position: relative; top: 12px;">0.9</span>
  ...
  <nav role="navigation" aria-label="main navigation" class="container nav-container overflowing" >
    ...
    <div class="nav-scroll">
      <ul class="nav-inner">
        ...
        <!-- <li class="nav-item help"><a href="https://github.com/trustfarm/taowallet/issues" target="_blank" rel="noopener">Help</a></li> -->
      </ul>
    </div>
