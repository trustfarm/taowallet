...
globalFuncs.printPaperWallets = function(strJson) {
    ...
    var data = "<html>\r\n\r\n<head>\r\n <link rel=\"stylesheet\" href=\"css\/etherwallet-master.min.css\" \/>\r\n <script type=\"text\/javascript\" src=\"js\/jquery-1.12.3.min.js\"><\/script>\r\n <script type=\"text\/javascript\" src=\"js\/etherwallet-static.min.js\"><\/script>\r\n <script type=\"text\/javascript\">\r\n function getBlockie(address) {\r\n return blockies.create({\r\n seed: address.toLowerCase(),\r\n size: 8,\r\n scale: 16\r\n }).toDataURL();\r\n    }\r\n    function generateWallets() {\r\n var json = JSON.parse($(\"#printwalletjson\").html());\r\n for (var i = 0; i < json.length; i++) {\r\n var walletTemplate = $(\'<div\/>\').append($(\"#print-container\").clone());\r\n new QRCode($(walletTemplate).find(\"#paperwalletaddqr\")[0], {\r\n text: json[i][\'address\'],\r\n colorDark: \"#000000\",\r\n colorLight: \"#ffffff\",\r\n correctLevel: QRCode.CorrectLevel.H\r\n });\r\n new QRCode($(walletTemplate).find(\"#paperwalletprivqr\")[0], {\r\n text: json[i][\'private\'],\r\n colorDark: \"#000000\",\r\n colorLight: \"#ffffff\",\r\n correctLevel: QRCode.CorrectLevel.H\r\n });\r\n                                                                                                        new QRCode($(walletTemplate).find(\"#wtfd\")[0], {\r\n text: json[i][\'account-info point\']\r\n });\r\n                                                                                    $(walletTemplate).find(\"#paperwalletadd\").html(json[i][\'address\']);\r\n $(walletTemplate).find(\"#paperwalletpriv\").html(json[i][\'private\']);\r\n $(walletTemplate).find(\"\").css(\'background-image\',\'url(\' + getBlockie(json[i][\'address\']) +\')\');\r\n walletTemplate = $(walletTemplate).find(\"#print-container\").show();\r\n $(\"body\").append(walletTemplate);\r\n }\r\n setTimeout(function() {\r\n window.print();\r\n }, 2000);\r\n    }\r\n    <\/script>\r\n<\/head>\r\n\r\n<body><span id=\"printwalletjson\" style=\"display: none;\">{{WALLETJSON}}<\/span>\r\n    <div class=\"print-container\" style=\"display: none; margin-bottom: 50px;\" id=\"print-container\"><img src=\"images\/logo-ethereum-1.png\" class=\"ether-logo-1\" height=\"100%\" width=\"auto\" \/> \r\n <img src=\"images\/print-sidebar.png\" height=\"100%\" width=\"auto\" class=\"bottom-img\" \/>\r\n                    <div id=\"wtfd\" style=\"height: 0px; position: relative; top:-20px;\"><div class=\"account-info point\" ng-dblclick=\"showLongBal=!showLongBal\" title=\"{{wallet.balance}} (Double-Click)\">\r\n    <div class=\"print-qr-code-1\">\r\n <div id=\"paperwalletaddqr\"><\/div>\r\n <p class=\"print-text\" style=\"padding-top: 12px;\">ADDRESS<\/p>\r\n <\/div>\r\n <div class=\"print-qr-code-2\">\r\n <div id=\"paperwalletprivqr\"><\/div>\r\n <p class=\"print-text\" style=\"padding-top: 30px;\">PRIVATE KEY<\/p>\r\n <\/div>\r\n <div class=\"print-address-container\" >\r\n <br \/><span id=\"paperwalletadd\"style=\"font-size: 9px; position: relative; left: 120px; bottom: 100px; word-break: break-all;\"><\/span><\/p>\r\n <br \/><span id=\"paperwalletpriv\" style=\"font-size: 9px; position: relative; left: -9px; bottom: 75px; word-break: break-all;\"><\/span><\/p>\r\n <\/div>\r\n     <div class=\"print-container\" style=\"display: none; margin-bottom: 50px;\" id=\"print-container\"><img src=\"images\/logo-ethereum-1.png\" class=\"ether-logo-1\" height=\"100%\" width=\"auto\" \/> \r\n <img src=\"images\/print-sidebar.png\" height=\"100%\" width=\"auto\" class=\"bottom-img\" \/>\r\n                    <div id=\"wtfd\" style=\"height: 0px; position: relative; top:-20px;\"><div class=\"account-info point\" ng-dblclick=\"showLongBal=!showLongBal\" title=\"{{wallet.balance}} (Double-Click)\">\r\n                    <div class=\"print-qr-code-3\">\r\n  <p class=\"print-text3\" style=\"font-weight: bold; padding-top:40px;\">카드이용시 주의사항<br \/> <\/p>\r\n <\/div>\r\n <div class=\"print-qr-code-4\">\r\n  <p class=\"print-text4\" style=\"font-weight: 300; font-size:12px;\">카드를 분실 또는 도난 당하여 발생한 부정사용은 <br \/>보상받지 못합니다.<\/p>\r\n <p class=\"print-text5\" style=\"font-weight: 300; font-size:12px;\">카드는 절대로 타인에게 빌려주지 마십시오.<\/p>\r\n<\/div>\r\n <div class=\"print-address-container\" >\r\n <br \/><\/p>\r\n <br \/><img src=\"images\/trustfarm-logo.svg\" class=\"ether-logo-3\" width=\"9%\" \/> <div class=\"trustfarm\"  style=\"position: absolute; right: 4px; bottom: -30px; font-size: 14px; font-weight: bold;\">\r\n https://trustfarm.io<\/p>\r\n<\/div>\r\n<\/p>\r\n <\/div>\r\n     <\/div>\r\n<\/body>\r\n\r\n<\/html>\r\n";
...
globalFuncs.donateAddress = "0x8df9f63bDdD6918590Fd283969CF9F3BD14b1793";
