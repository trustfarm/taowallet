...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : '귀하의 주소는 귀하의 계정 번호 또는 귀하의 공개 키로도 알려져 있습니다. 그것은 사람들과 공유하여 그들이 당신에게 이더 나 토큰을 보낼 수 있습니다. 다채로운 주소 아이콘을 찾으십시오. 어딘가에 주소를 입력 할 때마다 종이 지갑과 일치하는지 확인하십시오.',
