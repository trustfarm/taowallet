...
x_PasswordDesc              : '이 비밀번호는 개인 키를 * 암호화 * 합니다. 이것은 키를 생성하는 시드로 작용하지 않습니다. **지갑을 잠금 해제하려면이 비밀번호 + 개인 키가 필요합니다.**',
...
/* Gen Wallet Updates */
GEN_Help_1                  : '귀하의',
GEN_Help_2                  : '사용하여 귀하의 계정에 접속하세요.',
GEN_Help_3                  : '귀하의 기기에 귀하의 지갑이 있습니다.',
...
GEN_Help_8                  : '파일이 다운로드 안됩니까? ',
GEN_Help_9                  : 'Chrome을 사용해보세요. ',
GEN_Help_10                 : '파일을 마우스 오른쪽 버튼으로 클릭하여 저장. 파일 이름: ',
GEN_Help_11                 : '이 파일을 컴퓨터에서 열지 마십시오. ',
GEN_Help_12                 : 'TrustCoinWallet 또는 기타 지갑 클라이언트을 통해 지갑을 잠금 해제하는 데 사용하십시오. ',
GEN_Help_13                 : 'How to Back Up Your Keystore File ',
GEN_Help_14                 : 'What are these Different Formats? ',
GEN_Help_15                 : '자금 손실 및 도난 방지.',
GEN_Help_16                 : 'What are these Different Formats?',
GEN_Help_17                 : 'Why Should I?',
GEN_Help_18                 : '암호를 잊어 버린 경우를 대비하여 보조 백업을 가지고 있습니다.',
GEN_Help_19                 : 'In case you ever forget your password.',
GEN_Help_20                 : 'Cold Storage',
GET_ConfButton              : '이해했으면 다음 눌러주세요.',
GEN_Label_5                 : '`개인 키` 저장. ',
GEN_Unlock                  : '지갑의 잠금을 해제하여 주소를 확인하십시오.',
...
/* General */
x_Access                    : '액세스 ',
x_AddessDesc                : '귀하의 주소는 귀하의 계정 번호 또는 귀하의 공개 키로도 알려져 있습니다. 그것은 사람들과 공유하여 그들이 당신에게 이더 나 토큰을 보낼 수 있습니다. 다채로운 주소 아이콘을 찾으십시오. 어딘가에 주소를 입력 할 때마다 종이 지갑과 일치하는지 확인하십시오. 이것은 자신의 계좌 번호와 공개 키입니다. ETH를 전송하기 위해 필요한 정보입니다. 아이콘은 자신의 주소를 식별합니다. ',
x_Address                   : '내 주소 ',
x_Cancel                    : '취소 ',
...
/* Footer */
FOOTER_1                    : 'TrustCoinWallet 지갑 등을 생성하기위한 무료 오픈 소스 클라이언트 측 인터페이스. TrustCoinWallet과 쉽고 안전하게 상호 작용하십시오. 지갑을 잠금 해제하기 전에 URL (.com)을 다시 확인하십시오. ',
FOOTER_1b                   : '개발자 ',
...
HELP_16_Desc_1              : '[etherscan.io] (http://etherscan.io/) 와 같은 블록체인 탐색기를 사용할 수 있습니다. 주소를 검색 창에 붙여넣으면 주소와 거래 내역이 표시됩니다. 예를 들어, 우리의 [기부 계정]은 (http://etherscan.io/address/0x8df9f63bDdD6918590Fd283969CF9F3BD14b1793) 과 같습니다. ',
